...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="bar2">
            ...
            <a href="library.php"><li><i class="bi bi-layers-fill"></i></li></a><br>
                ...
                <a href="queue.php"><li> <i class="fa-solid fa-guitar" style="color: #dbf5f1"></i></li></a>
            </div>
    ...
    <div class="mainbar">
        ...
        <div class="liked">
            <h4>search to shine</h4>
            <h1>MY SEARCH</h1>
            <form method="post">
            <input type="text" name="search" placeholder="enter the songname">
        ...
        <div class="body">
           ...
           $search = $_POST['search'];
           $sql = "SELECT id, path, image, artist, name FROM gallery WHERE name LIKE '%$search%'";
...
const likedplaylist = JSON.parse(localStorage.getItem('length'));
